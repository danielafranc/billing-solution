...
import { StepTwoValidation, contractValidationSchema, stepThreeValidation } from './validation/validationSchema.js';
...
<FormStep stepName='Step 1' onSubmit={() => console.log('Step')} validationSchema={contractValidationSchema}>
  ...
  <FormStep stepName='Step 4' onSubmit={() => console.log('Step')} validationSchema={validationSchema} >
       <Step4/>
  </FormStep>
  <FormStep stepName='Step 5' onSubmit={() => console.log('Step')} validationSchema={validationSchema} >
       <Step5/>
  </FormStep>
